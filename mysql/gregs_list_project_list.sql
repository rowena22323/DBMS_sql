...
CREATE TABLE `project_list` (
  ...
  `est_cost` varchar(20) DEFAULT NULL,
...
INSERT INTO `project_list` VALUES (1,'outside house painting',NULL,'Murphy',NULL),(2,'kitchen remodel',NULL,'Valdez',NULL),(3,'wood floor instalation',NULL,'Keller',NULL),(4,'roofing',NULL,'Jackson',NULL);

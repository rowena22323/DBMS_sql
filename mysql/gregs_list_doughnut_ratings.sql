...
LOCK TABLES `doughnut_ratings` WRITE;
/*!40000 ALTER TABLE `doughnut_ratings` DISABLE KEYS */;
INSERT INTO `doughnut_ratings` VALUES ('Starbuzz Coffee','07:35:00','5/24','cinnamon',5,'state,but tasty');
/*!40000 ALTER TABLE `doughnut_ratings` ENABLE KEYS */;
UNLOCK TABLES;

...
where po_supplier.sup_no = po_order_header.sup_no and po_supplier.sup_name='LG전자' and to_char(po_order_header.ord_date,'yyyymm')='199712'
order by po_order_header.ord_date desc;
...
select distinct sup.sup_name, sup.sup_addr from po_employeer emp, po_order_header head, po_supplier sup 
...
order by sup.sup_name asc; --outer join?
